...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="text-left price-headline" style="color:#000000;">Assign User to Project</h3>
                </div>
            </div>
                  <hr>
            <?php
            ...
            ?>
             <form name="assign_user_toproject" action="AssignUserProject.php" method="post">
              ...
              <div class="row">
                  <div class="col-xs-12">
                    <h4 class="text-left price-headline" style="color:#000000;">Assigned  User to Project (<?php echo $totalProjectUsers; ?>)</h4>
                </div>
              </div>
              <br/>
              <?php
              ...
              <div class="row" >
                  <div class="col-xs-4">
                        <?php echo "<i class='fa fa-folder-o'></i> <a href='ManageProject.php'>" .$row['name']."</a>"; ?>
                  </div>
                  <div class="col-xs-3">
                        <?php  
