            ...
            <div class="row">
                <div class="col-xs-12 text-right">
                  <?php
                           ...
                           echo "<strong<center>$userRole</center></strong>";
                    ?>
                </div>
                <div class="col-xs-12">
                    <h3 class="text-left price-headline" style="color:#000000;">Browse Papers</h3>
                </div>
            </div>
            <br/>
            <div class="row">
                              ...
                              <br/>
                                  ...
                                  ?>
                                      <div class='row'>
                                          <div class='col-xs-4'>
                                              <?php 
                                                  echo "<i class='fa fa-folder-open'></i> <a href='#'>".$row['name']."</a><br/>";
                                          ...
                                          <div class='col-xs-4'>
                                                <?php
                                                    echo "<i class=' fa fa-link'></i> <a href='PapierInfo.php?pid=".$row['id']."'>".$row['title']."</a>";

                                                ?>
                                          </div>
                                          <div class='col-xs-4'>
                                                <?php
                                                    echo "<i class='fa fa-file-o'></i> <a href='uploads/".$row['file']."'>".$row['title']."</a>";
                              ...
                              <div role="tabpanel" class="tab-pane" id="messages">
                                ...
                                ?>
                                    <div class='row'>
                                        <div class='col-xs-12'>
                                            <?php
                                                echo "<div ><strong><i class='fa fa-file-o'></i> <a href='PapierInfo.php?pid=".$row['paperid']."'>".$row['title']."</a></strong><div style='padding-top:10px;'>".nl2br($row['comment'])."</div></div>";
                                                echo "<div><i class='fa fa-paperclip'></i> <a href='uploads/".$row['reviewedfile']."'>".$row['reviewedfile']."</a></div>";
                                                echo "<div style='text-align:right;background-color:#f1f1f1;'><a href='#".$code1.'-'.$row['memberid'].'-'.$code2."'>".$row['lastname'].' '.$row['firstname']."</a> <img class='img-circle' style='width:50px;height:50px;' src='".$photo."'><br/></div>"
                                             ?>
                                        </div>
                                    </div>
                                    <hr>
