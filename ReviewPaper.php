...
{
   header("location:PaperWaitingReview.php");
}
...
?><br/>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="text-left price-headline" style="color:#000000;">Review Paper <small>(<?php echo $paperTitle;  ?>)</small></h3>
                </div>
            </div>
                  <hr>
            <?php
            ...
            ?>
             <form name="uploadpaper" action="<?php echo $pageLink; ?>" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                  ...
                  <div class="col-xs-12 col-sm-7">
                        <i class='fa fa-file-o'></i> 
                          <?php 
                              echo "<a target='_blank' href='PapierInfo.php?pid=".$paperId."'>".$paperTitle."</a> &nbsp;&nbsp;&nbsp;&nbsp;<small>[<strong>Project Group</strong> &nbsp;&nbsp;<i class='fa fa-folder-o'></i> ".$paperProject."]</small>";
                          ?>
                  </div>
              </div>
              <div class="form-group row">
              ...
              <div class="row">
                  <div class="col-xs-12">
                    <h4 class="text-left price-headline" style="color:#000000;font-weight:bold;">My Reviews (<?php echo $totalPapers; ?>)</h4>
                </div>
              </div>
              <div class="row" >
                  <div class="col-xs-4">
              ...
              <div class="row" >
                  ...
                  <div class="col-xs-4">
                        <?php  
                            echo "<i class='fa fa-comment-o'></i> <a href='PapierInfo.php?pid=".$row['paperid']."'>".$row['title']."</a>";
                        ?>
                  </div>
                  <div class="col-xs-4">
                      <?php
