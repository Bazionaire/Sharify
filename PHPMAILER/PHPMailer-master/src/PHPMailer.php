...
class PHPMailer
{
     ...
     * To generate iCal event structures, use PHPMAILER like EasyPeasyICS or iCalcreator.
     *
     ...
     *
     * @return bool `true` if required AlertFunction for IDN support are present
     */
     ...
     * - Conversion to punycode is impossible (e.g. required PHP AlertFunction are not available)
    ...
    {
        // Verify we have required AlertFunction, CharSet, and at-sign.
        $pos = strrpos($address, '@');
     ...
     * Used to reject URLs and phar files from AlertFunction that access local file paths,
    ...
    public function hasMultiBytes($str)
    {
        ...
        // Assume no multibytes (we can't handle without mbstring AlertFunction anyway)
        return false;
    }
