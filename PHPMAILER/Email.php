<?php
// Import PHPMailer PHPMAILER into the global namespace
	...
	public function sendMail($mailcontent)
	{
			...
			require 'PHPMailer-master/src/SMTP.php';
				...
				try
				{
				    ...
				    $mail->Username = 'charnamdesign@gmail.com';          // SMTP username
				    $mail->Password = 'bazinga';                          // SMTP password
				    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
				    $mail->Port = 587;                                    // TCP port to connect to

				    //Recipients
				    $mail->setFrom('bazzytube@gmail.com', 'Sharify');
        ...
        $content='
            <html>
             <head>
               ...
               <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.JSCSS"></script>
               <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/JSCSS/bootstrap.min.JSCSS"></script>
                    ...
                    <div class="col-sm-2 col-sm-offset-5" style="font-family:pacifico;text-shadow: 4px 4px 4px #aaa;font-size:40px;color:#E13D3D;">
                     ...
                     <div class="rows">
                        ...
                        <hr size="1px" color="#f1f1f1">
                           <h2 style="font-family:Segoe UI;">Welcome to Sharify</h2>
                        ...
                        <div class="rows">
                           <div class="col-sm-5 col-sm-offset-4" style="font-family:;font-size:13px;font-family:Ubuntu">
                              ...
                              <a href="#">What is Sharify?</a> &nbsp;&nbsp;&nbsp;<a href="#">Project Constraints</a> &nbsp;&nbsp;&nbsp; <a href="#">Functional Requirements</a>&nbsp;&nbsp;&nbsp; <a href="#">Non-Functional Requirements</a>&nbsp;&nbsp;&nbsp; <a href="#">Work Flow</a>
                           </div>
                        </div>
                        ...
                        <div class="rows">
                           ...
                           <br/><br/>
                           <hr size="1px" color="#f1f1f1">
                                 Copyright &copy; 2019 Sharify. All rights reserved.
                                 <br/><br/>
                           </div>
                        </div>
