          ...
          if ($isAlreadyRegistered==0)
          {
              $result = $this->executeNewMemberFunc();
                    if ($result>0)
                    {
                        ...
                        $this->_subject = "Sharify membership registration";
                        $this->createActivation();
                        $this->_mailbody = "Thank you for registering on Sharify. Below are your username and password to access your membership account. <br>You are advised to change your password when logged in to one you can easily remember.<br/><br/>
