...
class User
{
    ...
    private function sendMail($email,$password,$lastname,$firstname)
    {
        ...
        $subject = "Sharify membership registration";
        $mailbody = "Thank you for registering on Sharify. Below are your username and password to access your membership account. <br>You are advised to change your password when logged in to one you can easily remember.<br/><br/>
