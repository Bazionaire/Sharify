...
?>  
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="text-left price-headline" style="color:#000000;">My Reviews (<?php echo $totalPapers; ?>)</h3>
                </div>
            </div>
                  <hr>
              <?php
                  foreach($list as $row)
                  {
                    ...
                    {
                       $assign="<a href='AssignReviewer.php?pid=".$row['paperid']."'><strong>Assign reviewer</strong></a>";
                    }
              ...
              <div class="row" >
                  <div class="col-xs-4" style='background-color: #f1f1f1;border-radius:5px;padding-top:10px;padding-bottom:15px;'>
                        ...
                        <br/>
                        <?php  
                            echo "<strong><big>Paper Title</big></strong><br/><i class='fa fa-comment-o'></i> <a href='PapierInfo.php?pid=".$row['paperid']."'><strong>".$row['title']."</strong></a><br/>";
                        ?>
                       <br/>
                       <?php
